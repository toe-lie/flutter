...
enum ForgeProjectType implements CliEnum {
  ...
  String get helpText => switch (this) {
    ...
    ForgeProjectType.dataClass => 'Generate a multi-package Flutter project.',
      };
...
class ForgeProjectMetadata {
  ...
  ForgeProjectMetadata(this.file, Logger logger) : _logger = logger,
    ...
    if (_validateMetadataMap(yamlRoot, <String, Type>{'project_type': String}, _logger)) {
      ...
      _projectType = ForgeProjectType.fromCliName(yamlRoot['project_type'] as String);
    }
