...
class ForgeCommand extends CreateBase {
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    String sanitizeClassName(String input) {
    ...
    final String className = sanitizeClassName(projectName);
    ...
    switch (template) {
      ...
      case FlutterProjectType.forge:
        final bool skipWidgetTestsGeneration =
            sampleCode != null || emptyArgument;
        generatedFileCount += await generateApp(
          <String>['forge', if (!skipWidgetTestsGeneration) 'app_test_widget'],
          relativeDir,
          templateContext,
          overwrite: overwrite,
          printStatusWhenWriting: !creatingNewProject,
